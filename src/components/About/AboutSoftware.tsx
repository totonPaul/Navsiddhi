        ...
        <div className="border-b border-body-color/[.15] pb-12 dark:border-white/[.15] md:pb-16 lg:pb-20">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="Software Unit"
                paragraph="Our software division is at the forefront of innovation, specializing in BizOps Automation Solutions. We develop advanced software tools that streamline business operations, enhance productivity, and reduce manual efforts. Our solutions are tailored to meet the specific needs of various industries, enabling businesses to operate more efficiently and effectively."
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    ...
                    <List text="Low Cost" />
                    <List text="Easy to setup" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="BizOps Solutions" />
                    <List text="Edtech Soutions" />
            ...
            <div className="w-full h-[200px] px-4 lg:w-1/2">
              <div className="relative mx-auto max-w-[500px] lg:mr-0" style={{ height: 'auto', width: '100%' }}>
                <Image
                  src="/images/slideshow/software.png"
                  alt="about-image"
