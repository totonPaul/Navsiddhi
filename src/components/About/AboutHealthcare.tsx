        ...
        <div className="border-b border-body-color/[.15] pb-12 dark:border-white/[.15] md:pb-16 lg:pb-20">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="Healthcare Unit"
                paragraph="Our healthcare division focuses on delivering top-notch oral and dental care. We provide a range of services from routine check-ups to advanced treatments, ensuring comprehensive care for our patients. Additionally, we are dedicated to pharmaceutical welfare, offering access to essential medications and health resources to improve overall well-being."
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    ...
                    <List text="Frequent Dental Camps" />
                    <List text="Patient friendly" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Oral Care" />
                    <List text="Dental Care" />
                    <List text="Pharmaceutical welfare" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full h-[200px] px-4 lg:w-1/2">
              <div className="relative mx-auto max-w-[500px] lg:mr-0" style={{ height: 'auto', width: '100%' }}>
                <Image
                  src="/images/slideshow/healthcare.png"
                  alt="about-image"
