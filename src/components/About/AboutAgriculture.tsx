        ...
        <div className="border-b border-body-color/[.15] pb-12 dark:border-white/[.15] md:pb-16 lg:pb-20">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="Agriculture Unit"
                paragraph="The agriculture wing emphasizes the importance of sustainable and traditional agricultural practices. We promote organic farming techniques that not only enhance the quality of produce but also preserve the environment. Our approach integrates time-honored methods with modern advancements to support sustainable agriculture and maintain soil health."
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    ...
                    <List text="Traditional Methods" />
                    <List text="Pure & natural" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Environmental Friendly" />
                    <List text="Sustainable practices" />
                    <List text="Organic Farming" />
                  </div>
                </div>
              </div>
            </div>
...
export default AboutAgriculture;
